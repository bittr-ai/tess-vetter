...
class EphemerisReliabilityRegimeCheck:
    ...
    def run(self, inputs: CheckInputs, config: CheckConfig) -> CheckResult:
        try:
            ...
            from tess_vetter.validation.ephemeris_reliability import (
...
class GhostFeaturesCheck:
    ...
    def run(self, inputs: CheckInputs, config: CheckConfig) -> CheckResult:
        ...
        try:
            ...
            from tess_vetter.validation.ghost_features import (
...
class SectorConsistencyCheck:
    ...
    def run(self, inputs: CheckInputs, config: CheckConfig) -> CheckResult:
        ...
        try:
            from tess_vetter.validation.sector_consistency import (
                SectorMeasurement,

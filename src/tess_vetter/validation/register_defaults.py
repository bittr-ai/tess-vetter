...
Usage:
    >>> from tess_vetter.validation import get_default_registry
...
def register_lc_only_checks(registry: CheckRegistry) -> None:
    ...
    """
    from tess_vetter.validation.checks_lc_wrapped import register_lc_checks
...
def register_extended_defaults(registry: CheckRegistry) -> None:
    ...
    from tess_vetter.validation.checks_extended_wrapped import register_extended_checks

...
def _default_cache_dir() -> Path:
    ...
    try:
        ...
        return Path(user_cache_dir("tess-vetter"))
    except ImportError:
        pass

    # 4. Fallback to CWD-relative
    return Path.cwd() / ".tess-vetter" / "cache" / "persistent_cache"
...
class PersistentCache:
    ...
    API is intentionally a superset of the original tess-vetter cache:

...
def build_rotation_context(
    *,
    rotation_period_days: float | None,
    stellar_radius_rsun: float | None,
    rotation_period_source_path: str | None = None,
    stellar_radius_source_path: str | None = None,
    rotation_period_source_authority: str | None = None,
    stellar_radius_source_authority: str | None = None,
) -> dict[str, Any]:
    ...
    return {
        ...
        "provenance": {
            "rotation_period_source_path": rotation_period_source_path,
            "stellar_radius_source_path": stellar_radius_source_path,
            "rotation_period_source_authority": rotation_period_source_authority,

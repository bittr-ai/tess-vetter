...
Delegates to `tess_vetter.validation.base`.
"""
...
from tess_vetter.validation.base import (  # noqa: F401
    count_transits,
    get_in_transit_mask,
...
def get_out_of_transit_mask_windowed(
    ...
    *,
    ...
    Delegates to `tess_vetter.pixel.aperture_family._compute_out_of_transit_mask`.
    """

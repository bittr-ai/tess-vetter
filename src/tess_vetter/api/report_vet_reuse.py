...
from tess_vetter.report._build_core import _compute_lc_summary, _validate_build_inputs
from tess_vetter.report._build_panels import (
...
from tess_vetter.report._build_utils import _to_internal_lightcurve
from tess_vetter.report._data import CheckExecutionState, ReportData
from tess_vetter.validation.report_bridge import run_lc_checks
...
def coerce_vetting_bundle(payload: VettingBundleResult | dict[str, Any]) -> VettingBundleResult:
    ...
    cli_vet_envelope_keys = {
        ...
        "sector_gating", "sector_measurements", "known_planet_match",
    }

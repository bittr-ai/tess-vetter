...
Delegates to `tess_vetter.validation.systematics_proxy`.
"""

from __future__ import annotations

from tess_vetter.api.references import PONT_2006, cite, cites
from tess_vetter.validation.systematics_proxy import (  # noqa: F401

...
def _apply_policy_mode(check: CheckResult, *, policy_mode: str) -> CheckResult:
    ...
    if policy_mode != "metrics_only":
        warnings.warn(
            "tess_vetter.api.* `policy_mode` is deprecated and ignored; "
            "tess-vetter always returns metrics-only results. "
...
def vet_lc_only(
    ...
    *,
    ...
    Example:
        >>> from tess_vetter.api import LightCurve, Ephemeris, vet_lc_only

...
Delegates to `tess_vetter.pixel.report`.
"""
...
from tess_vetter.pixel.report import (
    PixelVetReport,
...
generate_pixel_vet_report = cites(
    cite(
        BRYSON_2013,
        "Pixel-level diagnostics (difference images/centroids) for background false positives",
    ),

...
For most use cases, prefer the main `tess_vetter.api` exports.

Example:
    >>> from tess_vetter.api.primitives import (
...
from tess_vetter.api.primitives_catalog import (
    PRIMITIVES_CATALOG,
    PrimitiveInfo,
    list_primitives,
)
...
from tess_vetter.validation.checks_catalog import (

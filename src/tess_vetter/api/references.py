"""Central reference registry for tess-vetter.
...
Type Safety:
    ...
    from tess_vetter.api.references import THOMPSON_2018, cites, cite
...
Usage Examples:
    # Get all references
    >>> from tess_vetter.api.references import get_all_references
    ...
    >>> from tess_vetter.api.references import collect_module_citations
    >>> import my_module
...
ZECHMEISTER_KURSTER_2009 = reference(
    Reference(
...
def get_reference(ref_id: str) -> Reference:
    ...
    directly for type safety:
        ...
        # GOOD - type-safe, pyright catches typos at import time
        from tess_vetter.api.references import THOMPSON_2018
        ref = THOMPSON_2018
...
def generate_bibtex(refs: list[Reference] | None = None) -> str:
    ...
    Example:
        ...
        >>> from tess_vetter.api.references import THOMPSON_2018, COUGHLIN_2016
        >>> bibtex = generate_bibtex([THOMPSON_2018, COUGHLIN_2016])
    """
...
def cites(*refs_or_citations: Reference | Citation) -> Callable[[F], F]:
    ...
    Usage:
        from tess_vetter.api.references import THOMPSON_2018, COUGHLIN_2016, cites, cite
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1 and sys.argv[1] == "--markdown":
        ...
        print("Usage: python -m tess_vetter.api.references [--markdown|--bibtex]")

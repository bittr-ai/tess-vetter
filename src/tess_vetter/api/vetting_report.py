...
def format_vetting_table(
    ...
    *,
    ...
    """Format a :class:`~tess_vetter.validation.result_schema.VettingBundleResult` as a console table."""
...
def format_check_result(
    ...
    *,
    ...
    """Format a single :class:`~tess_vetter.validation.result_schema.CheckResult`.

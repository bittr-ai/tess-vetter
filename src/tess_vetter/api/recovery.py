...
from tess_vetter.api.transit_masks import count_transits
from tess_vetter.api.types import Candidate, LightCurve
from tess_vetter.compute.detrend import WOTAN_AVAILABLE
from tess_vetter.recovery import pipeline as _pipeline
...
if TYPE_CHECKING:
    from tess_vetter.activity.result import ActivityResult
...
def recover_transit(
    ...
    *,
    ...
    Example:
        >>> from tess_vetter.api import LightCurve, Candidate, Ephemeris
        >>> from tess_vetter.api.recovery import recover_transit
...
def detrend(
    ...
    *,
    ...
    Example:
        >>> from tess_vetter.api import LightCurve, Candidate, Ephemeris
        >>> from tess_vetter.api.recovery import detrend
        >>> lc = LightCurve(time=time, flux=flux, flux_err=flux_err)
...
def stack_transits(
    ...
    *,
    ...
    Example:
        >>> from tess_vetter.api import LightCurve, Candidate, Ephemeris
        >>> from tess_vetter.api.recovery import stack_transits

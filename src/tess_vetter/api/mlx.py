...
This module is a thin facade over `tess_vetter.compute.mlx_detection` to provide
...
from tess_vetter.api.references import KOVACS_2002, SUNDARARAJAN_2017, cite, cites
from tess_vetter.compute import mlx_detection as _mlx_detection

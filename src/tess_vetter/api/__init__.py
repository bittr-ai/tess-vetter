...
Advanced Usage:
    from tess_vetter.api.primitives import fold, median_detrend, check_odd_even_depth
    from tess_vetter.api.experimental import ...
...
"""
Implementation note:
`tess_vetter.api` historically re-exported a large surface area by eagerly importing many
...
if TYPE_CHECKING:
    ...
    # =========================================================================
    # v3 modules
    from tess_vetter.api import activity, recovery, timing, transit_fit

    # v3 activity characterization
    from tess_vetter.api.activity import characterize_activity, mask_flares
    from tess_vetter.api.alias_diagnostics import (  # noqa: F401
        PhaseShiftEvent,
        classify_alias,
    ...
    from tess_vetter.api.aperture import create_circular_aperture_mask

    # WCS-aware pixel tools (v0.2 supported surface)
    from tess_vetter.api.aperture_family import (
        DEFAULT_RADII_PX,
        ApertureFamilyResult,
        compute_aperture_family_depth_curve,
    )
    from tess_vetter.api.cadence_mask import default_cadence_mask

    # Utilities
    from tess_vetter.api.caps import (  # noqa: F401
    ...
    from tess_vetter.api.catalog import (
        exofop_disposition,
        nearby_eb_search,
        vet_catalog,
    )
    ...
    from tess_vetter.api.datasets import (  # noqa: F401
        LocalDataset,
        load_local_dataset,
        load_tutorial_target,
    )
    ...
    from tess_vetter.api.detection import (  # noqa: F401
        Detection,
        PeriodogramPeak,
        PeriodogramResult,
        TransitCandidate,
    ...
    from tess_vetter.api.detrend import (  # noqa: F401
        WOTAN_AVAILABLE,
        flatten,
        flatten_with_wotan,
        median_detrend,
    ...
    from tess_vetter.api.ephemeris_match import (  # noqa: F401
        EphemerisEntry,
        EphemerisIndex,
        EphemerisMatch,
    ...
    from tess_vetter.api.ephemeris_refinement import (  # noqa: F401
    ...
    from tess_vetter.api.ephemeris_specificity import (  # noqa: F401
    ...
    from tess_vetter.api.evidence_contracts import (  # noqa: F401
        EvidenceEnvelope,
        EvidenceProvenance,
        load_evidence,
        save_evidence,
    )
    from tess_vetter.api.evidence_contracts import (
        compute_code_hash as compute_evidence_code_hash,
    )

    # Exovetter checks (V11-V12, V11b)
    from tess_vetter.api.exovetter import (
        modshift,
        modshift_uniqueness,
        sweet,
        vet_exovetter,
    ...
    from tess_vetter.api.export import ExportFormat, export_bundle
    ...
    from tess_vetter.api.ghost_features import (  # noqa: F401
        GhostFeatures,
    ...
    from tess_vetter.api.lightcurve import (  # noqa: F401
        LightCurveData,
        LightCurveRef,
        make_data_ref,
    )
    from tess_vetter.api.localization import (
    ...
    # Optional MLX (guarded)
    from tess_vetter.api.mlx import (  # noqa: F401
        MlxT0RefinementResult,
        MlxTopKScoreResult,
        integrated_gradients,
        score_fixed_period,
    ...
    from tess_vetter.api.negative_controls import (  # noqa: F401
        ControlType,
        generate_control,
    ...
    from tess_vetter.api.periodogram import (  # noqa: F401
        PerformancePreset,
    ...
    from tess_vetter.api.pixel import (
        aperture_dependence,
        centroid_shift,
    ...
    from tess_vetter.api.pixel_prf import (  # noqa: F401
    ...
    # Prefilters (PFxx)
    from tess_vetter.api.prefilter import (  # noqa: F401
    ...
    # v3 transit recovery
    from tess_vetter.api.recovery import (  # noqa: F401
    ...
    from tess_vetter.api.reliability_curves import (  # noqa: F401
        compute_conditional_rates,
        compute_reliability_curves,
        recommend_thresholds,
    )
    from tess_vetter.api.generate_report import (  # noqa: F401
        GenerateReportResult,
        generate_report,
    )
    from tess_vetter.api.report import PixelVetReport, generate_pixel_vet_report

    # Sandbox compute primitives (host-facing)
    from tess_vetter.api.sandbox_primitives import (  # noqa: F401
        AstroPrimitives,
        astro,
        box_model,
        fold,
    ...
    from tess_vetter.api.sector_consistency import (  # noqa: F401
        ConsistencyClass,
        SectorMeasurement,
        compute_sector_consistency,
    )
    from tess_vetter.api.sector_metrics import (  # noqa: F401
        SECTOR_MEASUREMENTS_SCHEMA_VERSION,
        SectorEphemerisMetrics,
        V21SectorMeasurementRow,
        V21SectorMeasurementsPayload,
    ...
    from tess_vetter.api.stellar_dilution import (  # noqa: F401
        DilutionScenario,
        HostHypothesis,
        PhysicsFlags,
    ...
    from tess_vetter.api.stitch import (  # noqa: F401
        SectorDiagnostics,
        StitchedLC,
        stitch_lightcurves,
    )
    from tess_vetter.api.systematics import SystematicsProxyResult, compute_systematics_proxy

    # Target model contract (host-facing)
    from tess_vetter.api.target import (  # noqa: F401
        StellarParameters,
        Target,
    )

    # v3 timing analysis
    from tess_vetter.api.timing import analyze_ttvs, measure_transit_times
    from tess_vetter.api.tolerances import (  # noqa: F401
        HARMONIC_RATIOS,
        ToleranceResult,
        check_tolerance,
    )
    ...
    from tess_vetter.api.tpf import (  # noqa: F401
        TPFCache,
        TPFData,
        TPFHandler,
        TPFNotFoundError,
    ...
    from tess_vetter.api.tpf_fits import (  # noqa: F401
        TPFFitsCache,
        TPFFitsData,
    ...
    # v3 transit fitting
    from tess_vetter.api.transit_fit import TransitFitResult, fit_transit, quick_estimate
    from tess_vetter.api.transit_masks import (  # noqa: F401
        count_transits,
        get_in_transit_mask,
    ...
    from tess_vetter.api.triceratops_cache import (  # noqa: F401
        CalculateFppInput,
        FppResult,
    ...
    from tess_vetter.api.ttv_track_search import (  # noqa: F401
        TTVSearchBudget,
    ...
    # Main orchestrator
    from tess_vetter.api.vet import vet_candidate, vet_many
    ...
    from tess_vetter.api.wcs_utils import (
        compute_pixel_scale,
    ...
    from tess_vetter.api.check_runner import VettingSession, run_check, run_checks
    from tess_vetter.api.workflow import WorkflowResult, run_candidate_workflow
    from tess_vetter.api.vetting_report import format_check_result
    from tess_vetter.validation.registry import (  # noqa: F401
        CheckRegistry,
        CheckRequirements,
        CheckTier,
        VettingCheck,
    ...
    # =========================================================================
    from tess_vetter.plotting import (  # noqa: F401
        # V01-V05: Light curve checks
        plot_odd_even,
        plot_secondary_eclipse,
        plot_duration_consistency,
...
def __getattr__(name: str) -> Any:
    ...
    module, attr = target
    # Module re-exports (e.g., `from tess_vetter.api import transit_fit`).
    if module == "tess_vetter.api" and attr == name:
...
class _APIModule(_types.ModuleType):
    ...
    `tess_vetter.api.vet` sets `tess_vetter.api.vet` to a module),

"""Ephemeris matching and indexing utilities.
...
Design notes:
- This is intended to be a reusable, open-safe calculation layer.
- Curated ephemeris datasets (seed lists, blacklists, alias families) should live
  outside this package and be provided at runtime via `load_index()` or by building
  an `EphemerisIndex` in-memory.
"""

...
Downstream packages should prefer importing from `bittr_tess_vetter.api.enrichment`
instead of deep-importing `bittr_tess_vetter.pipeline` or CLI internals.
"""
...
from bittr_tess_vetter.features import EnrichedRow, FeatureConfig, RawEvidencePacket
